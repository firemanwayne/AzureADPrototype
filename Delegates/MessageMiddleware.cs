...
namespace AzureADPrototype.Delegates
{
    ...
    {
        public static IApplicationBuilder UseNotifications(this IApplicationBuilder app, IWebHostEnvironment environment)
        {
            if (environment.IsDevelopment())            
               return app.Use(WriteDevelopmentResponse);            
            else            
                return app.Use(WriteProductionResponse);            
        }
